...
names(data)[9]="q2" #quintil 2 de ingreso
names(data)[10]="q3"#quintil 3 de ingreso
names(data)[11]="q4"#quintil 4 de ingreso 
names(data)[12]="q5"#quintil 5 de ingreso
...
probit=glm(solpro~0+sexo+ne1+ne2+ne3+q2+q3+q4+q5+ing, family=binomial(link = probit))
probit=glm(solpro~0+cint+ing, family=binomial(link = probit))
summary(probit)
